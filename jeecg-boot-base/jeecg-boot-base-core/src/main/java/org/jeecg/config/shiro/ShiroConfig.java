...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/test/jeecg/**", "anon"); //测试接口排除
        filterChainDefinitionMap.put("/bsitest/userInfo/getToken", "anon"); //测试接口排除
        filterChainDefinitionMap.put("/bsitest/userInfo/getOnes", "anon"); //测试接口排除
